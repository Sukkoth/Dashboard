...
const ListDistricts = ({ districtData, fetchData, setTobeDeleted }) => {
  if (districtData?.districts?.length === 0) {
    return <LargeAlert isLoading={false} message={'No Districts data found'} />;
  } else
    return (
                ...
                <table className='table list-table table-bordered '>
                  <thead>
                    <tr>
                      ...
                      <th scope='col'>Lease Liability Account</th>
                  ...
                  <tbody>
                    {districtData?.districts?.map((district, index) => (
                      <tr key={district.districtId}>
                        ...
                        <td>{district?.leaseLiabilityAccount}</td>
                        <td>{district?.rouAccount}</td>
                        <td>{district?.branchCount}</td>
                        ...
                        <td className='d-flex align-items-center justify-content-center'>
                          <div className='dropdown dropstart'>
                            ...
                            >
                              ...
                              <li>
                                <Link
                                  to={`/hierarchy/branches/?districtId=${district?.districtId}`}
                                  className='dropdown-item'
                                >
                                  <i className='fa fa fa-building me-2 me-2'></i>
                                  Show branches
                                </Link>
                              </li>
                              <li>
                                <a
                                  ...
                                  onClick={() => {
                                    setTobeDeleted(district.districtId);
                                  }}
                                >
